import{r as l,i as d,n as g,a as u,b as m,x as p,t as h}from"./Header-BE1Rj1YH.js";import{g as f}from"./getPbImageURL-DBcEJeqA.js";import{g as w}from"./index-DjKJqAo0.js";var b=Object.defineProperty,v=Object.getOwnPropertyDescriptor,c=(e,t,o,s)=>{for(var a=s>1?void 0:s?v(t,o):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(a=(s?n(t,o,a):n(a))||a);return s&&a&&b(t,o,a),a};let r=class extends m{constructor(){super(...arguments),this.data={items:[],page:0,perPage:0,totalItems:0,totalPages:0},this.loginData={}}connectedCallback(){super.connectedCallback(),this.fetchData()}async fetchData(){const t=await(await fetch("https://surrounded-symbol.pockethost.io//api/collections/products/records")).json();this.data=t,this.loginData=JSON.parse(localStorage.getItem("auth")??"{}")}updated(e){super.update(e);const t=this.renderRoot.querySelectorAll(".product-item");t.length>0&&w.from(t,{y:30,opacity:0,stagger:.1})}render(){const{isAuth:e}=this.loginData;return p`
      <div class="container">
        <ul>
              ...
              <li class="product-item">
                <a href=${e?`/src/pages/detail/index.html?product=${t.id}`:"/"}>
                  ...
                  <div>
                    ...
                    <span class="real-price">${(t.price/100*(100-+t.discount)).toLocaleString()}원</span>
                  </div>
                </a>
              </li>
            `)}
